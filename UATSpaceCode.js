...
function Start(){
    ...
    //This will make the start button disabled if it has already been pushed. 
    document.getElementById("stopbutton").disabled = false;
    //This will make the start button enabled if the stop button has been pushed. 
}
function Stop(){
    console.log("Stop Button Pushed");
    document.getElementById("stopbutton").disabled = true;
    //This will disable the stop button after it has been pushed.
    document.getElementById("startbutton").disabled = false;
    //This will enable the start button once the stop button has been pushed. 
}
